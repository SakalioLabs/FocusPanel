...
> 0.10.88 起，76px 紧凑栏的开始、搜索、Focus 和状态入口不再只显示需要猜测的图标，而是在同一个圆角按钮内直接标出短标签。开始中心、搜索、Focus/设置、状态/电源或日历打开时，对应入口左侧持续显示一条强调色状态线；再次点击关闭表面后立即消失，让用户随时知道“按了什么、现在打开了什么”。
...
- `FocusPanel-0.11.2-full.nupkg`：完整更新包。
