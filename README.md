...
- 展开工作区直接显示概览、桌面收纳、任务、番茄钟、AI 和设置六个一级入口；紧凑栏“收纳”和“任务”普通点击分别直达两个最高频工作区。状态中心继续集中音量、静音、网络、电池、通知、输入法、显示桌面和电源操作。
...
“收纳”和“任务”按钮分别直接展开两个最高频工作区，标题下方固定显示概览、桌面收纳、任务、番茄钟、AI 和设置，不再创建重复的 Focus 中心或“工作”中转菜单。状态中心只放设备状态、Windows 公开入口与任务栏恢复信息；首屏保留常用动作、主音量和亮度，网络与无线、应用音量、媒体与电池使用三个默认折叠的单层详情区。
...
- `FocusPanel-0.11.1-full.nupkg`：完整更新包。
