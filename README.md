...
- 主动唤出后焦点落到“窗口”入口，可使用 Tab、Shift+Tab 或方向键循环浏览紧凑栏，Enter/Space 一步打开全部窗口总览；应用按钮向读屏提供应用名称和窗口摘要，Shift+F10 或菜单键打开右键菜单。`Ctrl+Alt+Space`（或本次注册的回退组合）仍直接打开“全部”统一搜索并全选查询。
